...
import cn.com.spbun.nddd.model.FKInfo;
...
public class Mysql55AnaylizerService extends AbstractMysqlAnaylizerService {
     ...
     * 
     * @see
     * cn.com.spbun.nddd.service.mysql.A#loadTableInfos(java.sql.Connection)
     */
    @Override
     ...
     * (non-Javadoc)
     * 
     * @see cn.com.spbun.nddd.service.mysql.A#loadColumns(java.sql.Connection,
     * java.util.List)
     */
    @Override
     ...
     * (non-Javadoc)
     * 
     * @see cn.com.spbun.nddd.service.mysql.A#loadFKInfo(java.sql.Connection,
     * cn.com.spbun.nddd.model.TableInfo, java.util.List)
     */
    @Override
     ...
     * 
     * @see
     * cn.com.spbun.nddd.service.mysql.A#loadTableCreateSQL(java.sql.Connection,
     * cn.com.spbun.nddd.model.TableInfo)
     */
    @Override
     ...
     * 
     * @see
     * cn.com.spbun.nddd.service.mysql.A#loadTableNames(java.sql.Connection)
     */
    @Override
