...
import cn.com.spbun.nddd.NdddApplication;
...
public class FileUtil {
    ...
    public static String getImagePath(String imageName) {
        return new File(getResourceImagePath(), imageName).getAbsolutePath();
    }

    private static String getResourceImagePath() {

        if (resourceImagePath != null) {
            return resourceImagePath;
        }

        File resourcePath = new File(getInstallPath(), "resources");
        File imagePath = new File(resourcePath, "images");

        resourceImagePath = imagePath.getAbsolutePath();
    ...
    public static String getInstallPath() {
        ...
        if (pack != null) {
            ...
            if (!packName.startsWith("cn.com.spbun")) {
